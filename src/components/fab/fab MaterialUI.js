...
/** CURRENTLY THE SPEED ACTION DIAL IS BUGGED ON TOUCHSCREENS (IT FAILS TO OPEN DRAWERS OR MODALS)
 * SEE: https://github.com/mui-org/material-ui/issues/16834
 * Untill the issue is fixed Floating Action Button will be from an external package "react-tiny-fab"
 */
const styles = theme => ({
  speedDial: {
    position: "fixed",
